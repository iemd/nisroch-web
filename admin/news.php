   ...
   // small images
	...
	$title=$_POST['title'];
        ...
        $detail=$_POST['detail'];
			...
			$insert = "INSERT INTO news(image,title,date,month,detail) VALUES ('$image','$title','$date','$month','$detail')";
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Latest News</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><a href="deletenews.php?id=<?php echo $rows['id'];?>"><i class="fa fa-trash fa-2x"></i></a>&nbsp;&nbsp;<a href="editnews.php?id=<?php echo $rows['id'];?>"><i class="fa fa-edit fa-2x"></i></a>&nbsp;&nbsp;<a href="editnewsimage.php?id=<?php echo $rows['id'];?>"><i class="fa fa-image fa-2x"></i></a></td>
                            </tr>
                           <?php }?>
                        </table>
                    </div>
